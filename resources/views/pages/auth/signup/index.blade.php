    ...
    <main class="min-h-screen bg-primary700">
        <div class="grid grid-cols-2">
            <div class="h-screen relative flex items-center">
                ...
                @if ($errors->any())
                    <div
                        class="z-30 mx-auto bg-[#FAFAFA] border-2 min-h-[5vh] rounded-lg py-5 border-err500 w-[20em] text-err500 px-8">
                        <ul class=" list-disc">
            ...
            <div class="flex justify-center items-center">
                <form action="{{ route('signup') }}" method="POST"
                    class="flex justify-center items-center bg-white w-[70%] h-[90%] rounded-3xl shadow-[0_10px_25px_rgba(0, 0, 0, 0.25)] ">
                    @csrf
                    <div class="flex flex-col justify-center items-center w-[70%]">
                        ...
                        <div class="w-full flex flex-col gap-3">
                            ...
                            <input required type="email" name="email" id="email"
                                class="w-full border-2 border-primary700 rounded-xl py-1 px-2 focus:outline-none">
                        </div>
                        ...
                        <div class="w-full mt-2 flex flex-col gap-3">
                            ...
                            <input required type="password" name="password_confirmation" id="password_conf"
                                class="w-full border-2 border-primary700 rounded-xl py-1 px-2 focus:outline-none">
                        </div>
                        <button type="submit"
                            class="font-semibold text-sm w-full bg-primary700 mt-10 py-3 text-white rounded-xl">Daftar</button>
