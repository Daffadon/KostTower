    ...
    <main class="min-h-screen bg-primary700 text">
        <div class="grid grid-cols-2">
            <div class="h-screen relative flex items-center">
                ...
                @if ($errors->any())
                    <div
                        class="z-30 mx-auto bg-[#FAFAFA] backdrop-blur-lg border-2 min-h-[5vh] rounded-lg py-5 border-err500 w-[20em] text-err500 px-8">
                        <ul class=" list-disc ">
                ...
                <form action="" method="POST"
                    ...
                    <div class="flex flex-col justify-center items-center w-[70%]">
                        ...
                        <div class="w-full mt-2 flex flex-col gap-3">
                            ...
                            <input type="password" name="password" id="sandi"
                                class="w-full border-2 border-primary700 rounded-xl py-1 px-2 focus:outline-none">
                        </div>
                        <button type="submit"
                            class="font-semibold text-sm w-full bg-primary700 mt-10 py-2 text-white rounded-xl">Masuk</button>
