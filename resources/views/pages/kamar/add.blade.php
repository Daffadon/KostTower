...
@section('content_title', 'Tambah Kamar')
            ...
            <div class="flex flex-col gap-4 py-14 px-24">
                <form class="flex flex-col gap-2" action="" method="POST">
                    ...
                    <input class="mt-4 h6 w-full border outline-none border-shade100 rounded-2xl py-4 px-6" type="text"
                        name="kode_kamar" placeholder="K00">
                    <p class="h5 font-bold">
                        Lantai
                    </p>
                    <input class="mt-4 h6 w-full border outline-none border-shade100 rounded-2xl py-4 px-6" type="text"
                    ...
                    <input
                        ...
                        type="text" name="harga" placeholder="Rp 0">
                    <div class="flex justify-center mt-10">
                        <button type="submit"
                            class="text-center font-semibold h5 bg-primary800 mt-10 py-3 text-white rounded-xl mb-10 w-[40%]">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
